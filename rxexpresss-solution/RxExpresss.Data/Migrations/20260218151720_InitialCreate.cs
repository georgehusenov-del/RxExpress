        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CutoffTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ZipCodes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryFee = table.Column<double>(type: "float", nullable: false),
                    SameDayCutoff = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PrioritySurcharge = table.Column<double>(type: "float", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    CircuitDriverId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AptUnit = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OptimizationStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Distributed = table.Column<bool>(type: "bit", nullable: false),
                    CircuitPlanId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceZoneId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CircuitStopId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RoutePlanId = table.Column<int>(type: "int", nullable: true),
                    ...
                    RequiresPhotoProof = table.Column<bool>(type: "bit", nullable: false),
                    SignatureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhotoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecipientNameSigned = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CopayCollected = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScannedByName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ScannedByRole = table.Column<string>(type: "nvarchar(max)", nullable: true),
