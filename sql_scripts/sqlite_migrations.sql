...
CREATE TABLE "RoutePlans" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_RoutePlans" PRIMARY KEY AUTOINCREMENT,
    "Title" TEXT NOT NULL,
    "Date" TEXT NOT NULL,
    "Status" TEXT NOT NULL,
    "OptimizationStatus" TEXT NOT NULL,
...
CREATE TABLE "ServiceZones" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ServiceZones" PRIMARY KEY AUTOINCREMENT,
    "Name" TEXT NOT NULL,
    "Code" TEXT NOT NULL,
    "IsActive" INTEGER NOT NULL,
    "ZipCodes" TEXT NOT NULL,
    "DeliveryFee" REAL NOT NULL,
    "SameDayCutoff" TEXT NOT NULL,
    "PrioritySurcharge" REAL NOT NULL,
    "CreatedAt" TEXT NOT NULL
);
...
CREATE TABLE "RoutePlanDrivers" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_RoutePlanDrivers" PRIMARY KEY AUTOINCREMENT,
    "RoutePlanId" INTEGER NOT NULL,
...
CREATE TABLE "RoutePlanOrders" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_RoutePlanOrders" PRIMARY KEY AUTOINCREMENT,
    "RoutePlanId" INTEGER NOT NULL,
...
ALTER TABLE "RoutePlans" ADD "CircuitPlanId" TEXT NULL;

ALTER TABLE "Orders" ADD "CircuitStopId" TEXT NULL;

ALTER TABLE "Drivers" ADD "CircuitDriverId" TEXT NULL;
