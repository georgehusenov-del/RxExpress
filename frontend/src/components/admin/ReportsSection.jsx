    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="border-slate-600 text-slate-300" data-testid="date-range-btn">
          ...
          <Button variant="outline" size="sm" onClick={fetchData} className="border-slate-600 text-slate-300" data-testid="refresh-reports-btn">
            <RefreshCw className="w-4 h-4 mr-2" />
            Refresh
          </Button>
          <Button size="sm" onClick={exportReport} className="bg-teal-600 hover:bg-teal-700" data-testid="export-report-btn">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="bg-slate-800 border border-slate-700">
          <TabsTrigger value="overview" className="data-[state=active]:bg-teal-600" data-testid="tab-overview">
            Overview
          </TabsTrigger>
          <TabsTrigger value="drivers" className="data-[state=active]:bg-teal-600" data-testid="tab-drivers">
            Drivers
          </TabsTrigger>
          <TabsTrigger value="boroughs" className="data-[state=active]:bg-teal-600" data-testid="tab-boroughs">
            Boroughs
          </TabsTrigger>
        </TabsList>
